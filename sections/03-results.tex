...
We applied padding to the shorter channels with the constant value 100, which does not appear in the original time series. 
...
In our downstream analysis, we adopted the combination of RNA sequence time series (2 to 4 channels), secondary structure time series (1 channel), and base-pair probability time series (1 channel) as our multivariate time series input, with 4 to 6 channels, depending on the encoding used.
...
For the encoding, it is suggested to use enc 7 or enc 9.
