...
Based on the filtering criterion (i.e., from Homo sapiens and having experimental support), we selected 827 experimentally validated pre-miRNA sequences, each with its two mature miRNA products.
