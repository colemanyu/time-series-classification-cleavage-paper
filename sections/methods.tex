...
Equipped with the matrix, we can construct the base-pair probability sequence of the original sequence. The first ten entries of the probability sequence of our running example are shown in~\ref{tab:hsa-let-7a-1}.
